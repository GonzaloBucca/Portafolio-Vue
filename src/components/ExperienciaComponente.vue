<script setup>
import icono1 from '/src/assets/programmer-svgrepo-com.svg';
import { ref } from 'vue';
const titulo = 'Tecnicatura en Programación';
const fecha = '2023/24';
const experiencias = ref([
    { id: 1, src: icono1, parrafo: '2 año de cursado de la Tecnicatura en Programación.' },
]);
</script>
